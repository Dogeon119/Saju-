...
| 페이즈 | 기능 | 왜 | 상태 |
|---|---|---|---|
| **II-1** | 공유 OG 이미지 카드 — `/r/[shareId]`에 카톡 미리보기 이미지(next/og, 모드·일주·브랜드) | 공유가 곧 마케팅, 링크가 예뻐야 눌린다 | 진행 |
| **II-2** | 궁합 초대 링크 — 내 정보만 채워 보내면 상대가 자기 생일 입력 후 둘 다 결과 열람 (`/i/[inviteId]`) | 상대 생일을 모르는 커플·썸 케이스 해소, 바이럴 루프 | 진행 |
| **II-3** | 오늘의 운세 — 프로필 기반 일운(십성·일진), 매일 새 글로 재방문 습관 | 회원 리텐션 엔진 (해요체 원고 필요) | 대기 |
